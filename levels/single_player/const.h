...
#define ENEMY_KNOCKBACK_GAIN 200
#define ENEMY_KNOCKBACK_FRICTION 0.9f
...
#define ENEMY_REPULSION_MODIFIER 0.1f
...
#define EASY_DIFF_ENEMY_DMG_DECREASE 5
#define EASY_DIFF_ENEMY_SPAWN_COOLDOWN_INCREASE 1
#define EASY_DIFF_ENEMY_SPEED_DECREASE 10

// debug options
#define DEBUG_HITBOXES 1
#define DEBUG_ABILITY_MESSAGES 0
#define DEBUG_GAME_INFORMATION 0
#define DEBUG_IO_INCLUDE (DEBUG_ABILITY_MESSAGES || DEBUG_GAME_INFORMATION)
